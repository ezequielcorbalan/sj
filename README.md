...
El ejercicio en si era sencillo, utilice yii2 ya que es un frame muy potente que tiene un crud generator impresionante.
El trabajo lo hice en 1:30, las complicaciones que tuve fueron las siguientes:
    ...
    *JQUERY UI no queria funcionar, peleando 20m lo pude hacer funcionar

Aspectos a mejorar
============================

Estos aspectos a continuacion no se mejoraron por falta de tiempo:
    ...
    *Usar Docker para dejar el entorno armado con el sistema
        (apache configurado con virtual hosts y direccion web)
    *instalar con composer
    
GII(CRUD generator)
============================
Para entrar y ver la herramienta tenes que poner 

    localhost/index.php?r=gii
     
Alli tendras todas las herramientas disponibles.
